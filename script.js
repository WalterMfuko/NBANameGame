...
let scores = {1: 0, 2: 0};
let hintsRemainingThisTurn = 2; // Each player gets 2 hints per turn
let currentStreak = 0;
let maxStreak = 0;
...
function initializeGame() {
    ...
    updateGameDisplay();
    updateScoreDisplay();
    hintsRemainingThisTurn = 2; // Set initial hints
...
function submitName() {
    ...
    if (error) {
        ...
        switchPlayer(); // Using the new function
        input.value = "";
        updateGameDisplay();
        updateScoreDisplay();
        return;
...
// Reset hints when switching player
...
// Add this function to update the streak counter
